...
```
  * The typical result of camera version is as the following figure which shows that the detection fps on Titan X (Pascal) is around 85. (I shoul have checked how it would change when a network for optical flow is added.)
